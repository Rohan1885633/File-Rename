...
DB_NAME = os.environ.get("DB_NAME", "johnwick720")
DB_URL = os.environ.get("DB_URL", "mongodb+srv://Johnwick:khan7860@cluster0.kht17ya.mongodb.net/?retryWrites=true&w=majority")
